...
class TestAddEditRouterDialog(unittest.TestCase):
    ...
    def test_add_router_success(self, MockRouter):
        ...
        self.dialog.parent.routers.append({'name': 'Router1', 'address': '192.168.1.1', 'login': 'admin'})
        self.assertIn({'name': 'Router1', 'address': '192.168.1.1', 'login': 'admin'}, self.parent.routers)
